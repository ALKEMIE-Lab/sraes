...
from sraes.data.tools import get_random_from_each_groupby_index
...
if __name__ == '__main__':
    ...
    ori_data = '0.20230502_ori_copy_20230201.xlsx'  # Ne Nve
    reconvert_fn = '1.20230502_clean.xlsx'
    normalized_fn = '2.normalized_data.xlsx'
    
    run_get_clean_file(read_fn=ori_data, to_fn=reconvert_fn)
    read_rename_clean_datafile(read_file=reconvert_fn, to_file=normalized_fn, is_corrcoed=False)
